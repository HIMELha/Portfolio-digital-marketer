...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-full bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white overflow-hidden "
    >
      {/* Background pattern */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8 order animate-fadeIn">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link
                href="#portfolio"
                className="px-8 py-4 bg-white text-blue-900 rounded-full font-medium hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 duration-300"
              >
                View My Work
              </Link>
            ...
            <div className="pt-12">
              ...
              <div className="flex space-x-6">
                <a
                  href="#"
                  className="h-12 w-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
                >
                  <svg
